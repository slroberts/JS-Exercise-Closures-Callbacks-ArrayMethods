...
function stringSmash(strings) {
  /* code here */
  const combinedString = strings.reduce(function (accumlator, currentValue) {
...
function firstNamesAllCaps(runners) {
  /* CODE HERE */
  const firstNametoUppercase = runners.map(function (runner) {
    return runner.first_name.toUpperCase();
  });

  return firstNametoUppercase;
}
...
function tallyUpDonations(runners) {
  /* CODE HERE */
  let initialValue = 0;
  const sumOfDonations = runners.reduce(function (accumlator, currentValue) {
